...
| [`runner/state/history.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/history.rs) | 현재 세션에서 승인된 prompt의 제한된 이력·검색 panel·초안 복원 | 접수 결과와 입력 우선순위는 `runner/state/input.rs`, 참조·이미지 복원은 `prompt/assist.rs` |
