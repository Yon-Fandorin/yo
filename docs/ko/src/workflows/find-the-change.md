...
|---|---|---|---|
| 해석된 key, 편집, paste, 설정 가능한 binding, 종료 gesture 변경 | [`yo-tui/src/input`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/input.rs) | 보이는 cursor 측정도 바뀌면 `prompt`, semantic agent action도 바뀌면 `runner` | [활성 Turn input](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.runtime.active-turn-input.md) |
| prompt 줄 바꿈, cursor 표시, prompt viewport 변경 | [`yo-tui/src/prompt`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/prompt.rs) | 영역 배분도 바뀌면 `shell` 또는 `layout`, 편집 의미도 바뀌면 `input` | [경계가 있는 view](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.surface.bounded-view.md) |
| 대화 기록 item, streaming update, scroll, page 이동 변경 | [`yo-tui/src/transcript`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/transcript.rs) | 대화 기록과 prompt 배분도 바뀌면 `shell`, event 해석도 바뀌면 `runner/state/observation.rs` | [typed TUI 흐름](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.runtime.typed-flow.md) |
| TUI input priority, editor submission, follow-up queue 변경 | [`yo-tui/src/runner/state/input.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/input.rs) | slash command effect도 바뀌면 `runner/state/commands.rs`, request correlation도 바뀌면 `runner/state/requests.rs` | [활성 Turn input](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.runtime.active-turn-input.md) |
| slash command 또는 new/resume/fork/model Session 전환 변경 | [`yo-tui/src/runner/state/commands.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/commands.rs) | core command·Session 의미도 바뀌면 `yo-core`, input priority도 바뀌면 `runner/state/input.rs` | [Session 생명주기](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.runtime.session-turn-activity.md) |
| Journal, durability, reference, Chat 관찰 변경 | [`yo-tui/src/runner/state/observation.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/observation.rs) | view formatting·viewport도 바뀌면 `runner/view.rs`, semantic record shape도 바뀌면 `yo-core` | [typed TUI 흐름](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.runtime.typed-flow.md) |
| request overlay, question/approval panel, response correlation 변경 | [`yo-tui/src/runner/state/requests.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/requests.rs) | 공통 selection·freshness도 바뀌면 `overlay`, request 의미도 바뀌면 `yo-core` | [observation view Projection](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.observability.view-projections.md) |
| interview working copy 또는 `TuiState` interview bridge 변경 | [`yo-tui/src/runner/state/interview.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/state/interview.rs) | interview 의미도 바뀌면 `yo-core`, input routing도 바뀌면 `runner/state/input.rs` | [활성 Turn input](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.runtime.active-turn-input.md) |
...
| shell 영역이나 완성된 frame 조합 변경 | [`yo-tui/src/shell`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/shell.rs)과 [`layout`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/layout.rs) | cell 쓰기나 clipping도 바뀌면 `surface`, 터미널 effect도 바뀌면 `terminal` | [Surface geometry](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.surface.geometry.md) |
| grapheme 너비, cell 소유권, clipping, 결정된 style, diff span 변경 | [`yo-tui/src/surface`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/surface.rs)와 [`text`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/text.rs) | Projection끼리 다르면 `terminal` 또는 `html`, 조합 정책도 바뀌면 호출한 component | [Surface model](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.surface.model-ownership.md) |
| 완성된 frame에서 생성되는 HTML 변경 | [`yo-tui/src/html`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/html.rs) | 공통 상태에 대해 터미널과 HTML이 다르면 `surface`, HTML encoding만 다르면 이 모듈에 유지 | [HTML Projection](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.surface.html-projection.md) |
| ANSI encoding이나 typed terminal operation 변경 | [`yo-tui/src/terminal`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/terminal.rs) | 화면 정책도 바뀌면 `terminal/mode`, OS effect도 바뀌면 `terminal/backend` | [터미널 operation](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.surface.terminal-ops.md) |
| Inline·Fullscreen 표시, viewport update, 복원 변경 | [`yo-tui/src/terminal/mode`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/terminal/mode.rs) | Unix 획득이나 출력도 바뀌면 `terminal/backend`, 프로세스 signal 동작도 바뀌면 `yo-cli/execution/process` | [생명주기 복원](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.terminal.lifecycle-restoration.md) |
| live loop의 input·event 순서, backpressure 처리, TUI event Projection 변경 | [`yo-tui/src/runner`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner.rs) | Session admission이나 event 의미도 바뀌면 `yo-core/agent_session`, 터미널 정책도 바뀌면 `terminal/mode` | [typed TUI 흐름](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.runtime.typed-flow.md) |
...
| frontend admission, backpressure, worker 소유권, 시작 취소, 종료 변경 | [`yo-core/src/agent_session`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/agent_session.rs) | semantic transition도 바뀌면 `engine` 또는 `runtime`, TUI gesture도 바뀌면 `yo-tui/runner`로 돌아감 | [command와 event 경계](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.runtime.command-event-boundary.md) |
| provider 중립 backend port나 command 수락 순서 변경 | [`yo-core/src/backend/contract.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/backend/contract.rs)와 [`runtime`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/runtime.rs) | 한 host의 wire 동작도 바뀌면 해당 `backends/delegated-*` crate, 공개 frontend 사용법도 바뀌면 `lib.rs`와 `agent_session` | [프런트엔드 독립 코어](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.core.frontend-independent-boundary.md) |
...
| Grok process, ACP protocol, 인증, permission, Session 연결, event 변환 변경 | [`backends/delegated-grok`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/backends/delegated-grok/src/lib.rs) | provider 중립 의미도 바뀌면 `backend/contract`, `runtime`, `engine` | [Backend 실행 topology](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/agent-runtime/agent.backend.execution-topology.md) |
| CLI 인자, 작업 디렉터리 확보, 시작 순서, 최상위 failure 취합 변경 | [`yo-cli/src/main.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/main.rs), [`yo-cli/src/lib.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/lib.rs), [`yo-cli/src/application.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/application.rs), [`yo-cli/src/application/runtime/startup.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/application/runtime/startup.rs), [`yo-cli/src/application/runtime/live.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/application/runtime/live.rs) | agent adapter도 바뀌면 `application/agent`, signal 정책도 바뀌면 `execution/process/termination` | [모듈 및 호스트 경계](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.architecture.module-boundaries.md) |
| `Ctrl+Z`, 기본 프로세스 일시정지, `SIGCONT`, 터미널 세대 재진입 변경 | [`yo-cli/src/execution/process/job_control.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/execution/process/job_control.rs)와 [`yo-tui/src/runner`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner.rs) | 보존하는 application 상태 중 status·document metadata는 [`runner/session/metadata.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/session/metadata.rs), 생성은 [`runner/session/construction.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/session/construction.rs), resume/tree/fork 전환은 [`runner/session/continuation.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/session/continuation.rs), host bridge는 [`runner/session/bridges.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/session/bridges.rs), 세대와 맞닿은 session state는 [`runner/session/generation.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-tui/src/runner/session/generation.rs)가 소유한다. lease 최종 확정에서 종료가 우선하면 `execution/process/termination` | [job-control 일시정지와 재개](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.terminal.job-control-suspend-resume.md) |
| Unix 종료 관찰, signal 우선순위·disposition·복원 변경 | [`yo-cli/src/execution/process/termination`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-cli/src/execution/process/termination.rs) | 터미널 복원도 바뀌면 `yo-tui/terminal/mode`, typed 관찰도 바뀌면 `yo-tui/runner` | [프로세스 종료 coordinator](https://github.com/Yon-Fandorin/yo/blob/develop/methexis/knowledge/tui-architecture/tui.runtime.process-termination-coordinator.md) |
...
| 증상 | 이 순서로 추적 |
|---|---|
| 제출한 text는 보이지만 Turn이 시작되지 않음 | `yo-tui/runner/state/input.rs` → `yo-cli/agent` → `yo-core/agent_session/admission.rs` → worker/runtime → backend |
| delegated host가 작업을 수락했지만 대화 기록이 갱신되지 않음 | 해당 `backends/delegated-*/events.rs` → `AgentRuntime::poll_event`와 Journal 추가 → agent-session 변경 알림 → `yo-cli/agent` Transcript cursor → `runner/state/observation.rs`의 `TuiState::observe_record` → Chat transcript |
| Chat은 갱신되지만 Transcript나 Request가 잘못됨 | `runner/state/observation.rs` → `runner/view.rs`의 record formatting과 정확한 context anchor → 공통 `transcript` layout. correlation은 `runner/state/requests.rs`를 확인하고 필요한 semantic record나 correlation 자체가 없을 때만 `yo-core` 확인 |
...
3. 각 delegated host의 wire protocol은 해당 `backends/delegated-*` crate, 터미널 type은 `yo-tui` 안에 둔다.
