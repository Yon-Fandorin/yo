...
If termination arrives during the handshake, `AgentSession::start_inner` in
[`agent_session/startup.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/agent_session/startup.rs)
...
4. [`AgentWorker`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/agent_session/worker/lifecycle.rs)
