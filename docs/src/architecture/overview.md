...
| `yo-core` | Agent session semantics, commands and events, and provider-neutral backend ports | [`crates/yo-core/src/lib.rs`](https://github.com/Yon-Fandorin/yo/blob/develop/crates/yo-core/src/lib.rs) |
