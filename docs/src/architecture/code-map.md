...
own the provider-neutral identity and local-secret boundaries. The current
foundation exposes those boundaries but does not yet select or start a native
model connector. The
