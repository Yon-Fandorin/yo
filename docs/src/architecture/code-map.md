...
This paragraph describes the current live TUI seam. The archived
`yo session SESSION_ID --view request` path instead prints the complete stored
Session correlation trace and has no anchor selector.
