...
| Formal Slice resumes with stale evidence or a rewritten candidate | [status](../tools/xtask/src/slice_status.rs) | `cargo xtask slice status <slice>` and its returned next action | Evidence-chain or status protocol changes |
