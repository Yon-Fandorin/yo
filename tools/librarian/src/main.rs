...
const IO_ERROR: &[u8] = b"\
{\"schema\":\"librarian.error/v1alpha1\",\"ok\":false,\"operation\":\"discover\",\"error\":{\"code\":\"io_error\",\"message\":\"cannot write the complete structured result\",\"affected_ids\":[],\"affected_paths\":[],\"next_actions\":[\"retry with writable stdout and stderr\"]}}
";
