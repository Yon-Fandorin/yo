...
use crate::{
    git,
    review::{
        delta::model::{Manifest, PRIOR_FINDINGS_SCHEMA, PriorFinding, PriorFindings},
        packet::{VerifiedReview, storage},
    },
    review_protocol::{
...
"#,
    ...
    let seed = crate::review::packet::tests::support::publish_original(
        &repository.path,
        &base_commit,
        &candidate_a,
        &candidate_a,
...
fn legacy_v1_alias_replays_while_v1_alpha1_rejects_it() {
    ...
    let prior = VerifiedReview {
        ...
        validation_evidence: vec![crate::review::packet::VerifiedEvidence {
            name: "baseline".to_owned(),
...
fn v1_alpha1_original_roots_v1_alpha1_delta_chain() {
    assert_experimental_original_roots_accept_v1_alpha1_delta(
        ...
        crate::review::packet::tests::support::publish_original_v1_alpha1,
    );
}
...
fn v1_alpha2_original_roots_v1_alpha1_delta_chain() {
    assert_experimental_original_roots_accept_v1_alpha1_delta(
        ...
        crate::review::packet::tests::support::publish_original_v1_alpha2,
    );
}
