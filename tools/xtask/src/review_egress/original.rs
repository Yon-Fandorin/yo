...
use super::{
    ...
    model::{
        ...
        ResultDocument, ReviewKind, Session,
    },
    validation::{
...
#[derive(Debug)]
pub(super) struct CapturedDeliveryReceipt {
    path: PathBuf,
    bytes: Vec<u8>,
...
pub(super) fn validate_authorization(authorization: &Authorization) -> Result<(), String> {
