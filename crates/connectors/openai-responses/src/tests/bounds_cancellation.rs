use serde_json::json;
use yo_core::{
    ApiCredential, ConnectorFailureKind, ModelConnectorCancellation, ModelConnectorInputItem,
    ModelConnectorInputRole, ModelConnectorLimits, ModelConnectorRequest, RequestToolExposure,
};

use super::responses_binding;
use crate::{OpenAiResponsesConnector, sse::ResponsesSseDecoder};
