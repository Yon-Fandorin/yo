...
pub use model_service::{
    ...
    KIMI_PRIVATE_REPLAY_PROFILE, KimiAccountCapacityError, KimiAccountCapacityFailureKind,
    KimiCatalogAvailability, KimiCatalogDisabledReason, KimiCatalogError, KimiCatalogFailureKind,
    KimiCatalogModel, KimiCatalogSeed, LocalConnectionOperationGuard,
    ...
    OpenRouterModelAvailability, OpenRouterModelCapabilities, PreparedAccountSessionMutation,
    PreparedConnectionMutation, PreparedCredentialMutation, PreparedExternalConnection,
    PreparedExternalDisconnect, ProviderId, QwenCloudCatalogAvailability,
    QwenCloudCatalogDisabledReason, QwenCloudCatalogModel, QwenCloudCatalogSeed,
    ...
    discover_kimi_models, discover_openrouter_models, parse_kimi_account_capacity_snapshot,
    parse_kimi_catalog_snapshot, plan_connection_recovery, read_kimi_account_capacity,
