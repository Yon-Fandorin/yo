...
pub use model_service::{
    ...
    StoredModelBinding, VersionedProfileId, discover_kimi_models, discover_openrouter_models,
    parse_kimi_account_capacity_snapshot, parse_kimi_catalog_snapshot, plan_connection_recovery,
    read_kimi_account_capacity, resolve_startup_target,
};
